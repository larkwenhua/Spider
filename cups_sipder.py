...
class Cups:
    ...
    def clear(self):
        ...
        with open("D:\data\cup_all.csv", "w+", encoding="utf-8") as f:
    ...
    def extract():
        ...
        with open(r"D:\data\size_color.txt", "r", encoding="utf-8") as fin:
            rows = fin.readlines()
            lst = []
            for row in rows:
                lst.append((row.split(";")[1]))
        with open(r"D:\data\size.txt", "w+", encoding="utf-8") as fout:
            fout.writelines(lst)
